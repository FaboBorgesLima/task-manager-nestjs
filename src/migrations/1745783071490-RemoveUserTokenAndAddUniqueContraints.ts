...
export class RemoveUserTokenAndAddUniqueContraints1745783071490 implements MigrationInterface {
    name = 'RemoveUserTokenAndAddUniqueContraints1745783071490'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_7869db61ed722d562da1acf6d59"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_7869db61ed722d562da1acf6d59" UNIQUE ("token")`);
    }
